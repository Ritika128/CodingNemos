  ...
  return (
    <div className="home-container">
      ...
      <div className="text">
        ...
        <p onClick={handleBuy}>unleash your creative potential with our NFT platform, where accessible and secure tools are at your disposal to transform your art into NFTs.</p>
